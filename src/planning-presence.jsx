                      ...
                      <React.Fragment key={teamName}>
                        ...
                        {teamAgents.map((agent,i)=>{
                          ...
                          <tr key={agent.id} style={{borderBottom:"1px solid #f1f5f9",height:36,background:selectedAgentRow===agent.id?"#f0f1ff":rowBg,transition:"all 0.15s",cursor:"pointer"}}
                            ...
                            onMouseEnter={e=>{!selectedAgentRow&&(e.currentTarget.style.background=(agentIndex+i)%2===0?"#f5f6f8":"#f0f2f5");const btns=e.currentTarget.querySelector("[data-sort-buttons]");if(btns)btns.style.opacity="1";}}
                            onMouseLeave={e=>{!selectedAgentRow&&(e.currentTarget.style.background=rowBg);const btns=e.currentTarget.querySelector("[data-sort-buttons]");if(btns)btns.style.opacity="0";}}>
